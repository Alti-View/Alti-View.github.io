...
(function () {
  ...
  K.ready = !webglOK()
    ...
    : (window.THREE && window.RoomEnvironment)
      ? Promise.resolve((K.THREE = window.THREE, K.RoomEnvironment = window.RoomEnvironment, window.THREE))
      : Promise.reject(new Error('Three.js absent'));
