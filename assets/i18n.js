...
(function () {
  ...
  var EN = {
    ...
    'Choix de la facturation': 'Billing choice', 'Mensuel': 'Monthly', 'Annuel': 'Annual', '2 mois offerts': '2 months free',
    "Passez à l'annuel :": 'Switch to annual:',
    'Élève & découverte': 'Student & discovery', '/ accès anticipé': '/ early access',
    "Gratuit pendant l'accès anticipé": 'Free during early access',
    'Sans engagement': 'No commitment',
    '€ par an': '€ a year', 'Économisez': 'Save',
    ...
    'Tarif étudiant': 'Student price', 'Élèves et étudiants': 'Students',
    'Sur Pilote VFR Pro, 4 € de moins chaque mois.': 'On VFR pilot Pro, 4 € less every month.',
    'Par mois': 'Per month', 'Par an': 'Per year', 'Économisez 40 € par an': 'Save 40 € a year',
    'Vous payez directement au tarif réduit. Envoyez ensuite votre justificatif de scolarité à': 'You pay the reduced price directly. Then send your proof of enrolment to',
    ", sous quinze jours : carte étudiante, certificat de scolarité ou attestation d'inscription en aéroclub.": ', within fifteen days: student card, school certificate or flying club enrolment letter.',
    'Appliquer le tarif étudiant': 'Apply the student price',
    'Mon profil': 'My profile', 'Enregistrer': 'Save', 'Changer de formule': 'Change plan', 'Aucune': 'None',
    'Ces informations suivent vos dossiers de vol et situent votre terrain de rattachement.': 'These details follow your flight files and locate your home airfield.',
    'Retour à': 'Back to', 'mon espace': 'my account',
    'Recommandé': 'Recommended', 'Pilote VFR': 'VFR pilot', 'Pilote VFR Pro': 'VFR pilot Pro', '/ mois': '/ month',
        'Toute la préparation au sol, de la carte au devis de masse, sur vos trois écrans.': 'All your ground preparation, from the map to the weight and balance, on your three screens.',
    'Carte interactive et NavLog automatique': 'Interactive map and automatic NavLog',
    'Calcul de cap, de temps et de consommation': 'Heading, time and fuel burn calculation',
    '1 profil avion standardisé (C152, C172, DR-400, PA28 ou DA40)': '1 standard aircraft profile (C152, C172, DR-400, PA28 or DA40)',
    'Sur ordinateur, tablette et téléphone': 'On computer, tablet and phone',
    'Devis de masse et centrage': 'Weight and balance',
    'Checklists standard et dossier de vol': 'Standard checklists and flight file',
    'Carte VFR interactive et NavLog automatique': 'Interactive VFR chart and automatic NavLog',
    'Cap, temps de vol et bilan carburant': 'Heading, flight time and fuel plan',
    'Devis de masse et centrage, vitesses caractéristiques': 'Weight and balance, characteristic speeds',
    "Performances de décollage et d'atterrissage": 'Take-off and landing performance',
    'Un profil avion personnalisable (C152, C172, DR-400, PA28 ou DA40)': 'One customisable aircraft profile (C152, C172, DR-400, PA28 or DA40)',
    "Checklists, procédures d'urgence et dossier de vol": 'Checklists, emergency procedures and flight file',
    'Obtenir Pilote VFR': 'Get VFR pilot', 'Obtenir Pilote VFR Pro': 'Get VFR pilot Pro',
    "Tout Pilote VFR, plus ce qu'il faut emporter à bord et garder après le vol.": 'Everything in VFR pilot, plus what you need on board and after the flight.',
    'Tout Pilote VFR inclus': 'Everything in VFR pilot included',
    'Dossier de vol PDF, archivage et carnet de vol': 'PDF flight file, archiving and logbook',
    'Support prioritaire': 'Priority support',
    ': NavLog, météo, carte, centrage, checklists': ': NavLog, weather, map, weight and balance, checklists',
    'Profils avions illimités': 'Unlimited aircraft profiles',
    'Profils avions illimités, avec la fiche de pesée réelle de la machine': "Unlimited aircraft profiles, with the aircraft's actual weighing report",
    'Navigations enregistrées, rejouables en un clic': 'Saved routes, flown again in one click',
    'Carnet de vol qui se remplit depuis vos dossiers de vol': 'A logbook that fills itself from your flight files',
    'Dossier de vol PDF, archivé et partageable par lien': 'PDF flight file, archived and shareable by link',
    'Alertes NOTAM et SUP AIP sur votre route': 'NOTAM and AIP SUP alerts along your route',
    'Statistiques de vol et carte des terrains visités': 'Flight statistics and a map of the airfields you have visited',
    ...
    'Aéroclub': 'Flying club', 'Sur mesure': 'Custom',
    ...
    'Pilote VFR Pro pour chaque membre du club': 'VFR pilot Pro for every club member',
    'Flotte partagée : les fiches de pesée réelles saisies une fois pour tous': 'Shared fleet: actual weighing reports entered once for everyone',
    'Comptes créés et gérés par le club, arrivées et départs compris': 'Accounts created and managed by the club, joiners and leavers included',
    'Dossiers de vol des élèves partagés avec les instructeurs': 'Student flight files shared with instructors',
    'Devis au nombre de places, facturation annuelle': 'Quoted per seat, billed annually',
    ...
    'Objet': 'Subject',
    'Abonnement Pilote VFR': 'VFR pilot plan', 'Abonnement Pilote VFR Pro': 'VFR pilot Pro plan', 'Offre Élève et découverte': 'Student and discovery plan', 'Autre question': 'Other question',
    ...
    /* espace pilote: connexion et inscription */
    'Fermer': 'Close', 'Espace pilote': 'Pilot area',
    'Retrouvez vos avions, vos navigations et vos dossiers de vol.': 'Find your aircraft, your cross-country flights and your flight files.',
    'Adresse e-mail': 'Email address', 'prenom@exemple.fr': 'first@example.com',
    'Mot de passe': 'Password', 'Afficher le mot de passe': 'Show password',
    'Rester connecté': 'Stay signed in', 'Mot de passe oublié ?': 'Forgot your password?',
    "L'espace pilote ouvre avec l'accès anticipé. Écrivez-nous à": 'The pilot area opens with early access. Email us at',
    'et nous vous prévenons dès que votre compte est prêt.': 'and we will tell you as soon as your account is ready.',
    "Vous n'avez pas encore de compte ?": "Don't have an account yet?", "S'enregistrer": 'Sign up',
    'Créer un compte': 'Create an account',
    'Quelques informations et votre espace est prêt pour votre première navigation.': 'A few details and your space is ready for your first cross-country flight.',
    'Prénom': 'First name', 'Nom': 'Last name',
    'Confirmer le mot de passe': 'Confirm password', '8 caractères minimum, dont un chiffre.': 'At least 8 characters, including one digit.',
    'Formule souhaitée': 'Plan you want', 'Aéroclub ou aérodrome de rattachement': 'Home flying club or airfield',
    "J'accepte les": 'I accept the', 'et la': 'and the', 'politique de confidentialité': 'privacy policy',
    'Je souhaite recevoir les nouveautés Altiview par e-mail.': 'I would like to receive Altiview news by email.',
    'Créer mon compte': 'Create my account',
    "Les inscriptions ouvrent avec l'accès anticipé. Écrivez-nous à": 'Sign-ups open with early access. Email us at',
    "pour réserver votre place, nous créons votre espace à l'ouverture.": 'to reserve your place, we create your space when it opens.',
    'Vous avez déjà un compte ?': 'Already have an account?',
    'Récupération de compte': 'Account recovery', 'Mot de passe oublié': 'Forgotten password',
    "Saisissez l'adresse e-mail de votre compte. Nous vous envoyons un code de vérification à 6 chiffres, valable 10 minutes.": 'Enter the email address of your account. We send you a 6-digit verification code, valid for 10 minutes.',
    'Envoyer le code': 'Send the code',
    'Vous vous souvenez de votre mot de passe ?': 'Remember your password?',
    'Vérification en deux étapes': 'Two-step verification', 'Entrez le code': 'Enter the code',
    'Code à 6 chiffres envoyé à': '6-digit code sent to', 'votre adresse': 'your address', 'Il expire dans': 'It expires in',
    'Chiffre 1': 'Digit 1', 'Chiffre 2': 'Digit 2', 'Chiffre 3': 'Digit 3', 'Chiffre 4': 'Digit 4', 'Chiffre 5': 'Digit 5', 'Chiffre 6': 'Digit 6',
    'Vérifier le code': 'Check the code', 'Rien reçu ? Pensez aux indésirables.': 'Nothing received? Check your spam folder.',
    'Renvoyer le code': 'Send a new code',
    "L'envoi du code par e-mail sera actif à l'ouverture de l'espace pilote. Besoin d'aide maintenant ? Écrivez-nous à": 'Sending the code by email starts when the pilot area opens. Need help now? Email us at',
    'Mauvaise adresse ?': 'Wrong address?', 'Recommencer': 'Start again',
    'Nouveau mot de passe': 'New password',
    "Choisissez un mot de passe que vous n'utilisez nulle part ailleurs.": 'Choose a password you do not use anywhere else.',
    'Enregistrer le mot de passe': 'Save the password',
    "La récupération de compte sera active à l'ouverture de l'espace pilote. Écrivez-nous à": 'Account recovery starts when the pilot area opens. Email us at',
    'et nous reprenons la main sur votre compte.': 'and we will take care of your account.',
    'Retour à la': 'Back to', 'connexion': 'sign in',
    'Continuer avec Google': 'Continue with Google', 'Continuer avec Apple': 'Continue with Apple',
    'ou': 'or', 'ou créez un compte avec votre adresse': 'or create an account with your email',
    'Vous êtes connecté': 'You are signed in', 'Session ouverte avec': 'Signed in as', 'votre adresse': 'your address',
    'Pilote': 'Pilot', 'Aéroclub': 'Flying club', 'Formule': 'Plan',
    "Ouvrir l'application": 'Open the app', 'Se déconnecter': 'Sign out',

    /* footer */
    'La préparation et la conduite du vol VFR, dans une seule application.': 'VFR flight planning and flying, in a single app.',
    'Produit': 'Product', 'Légal': 'Legal', 'Mentions légales': 'Legal notice', 'Confidentialité': 'Privacy', 'CGV': 'Terms of sale',
